...
-DBUILD_SHARED_LIBS=%build_shared% -DCMAKE_BUILD_TYPE=%build_type% -DCMAKE_CXX_COMPILER_VERSION=clang ^
-DAWSSDK_ROOT_DIR=%GAMEKIT_ANDROID_AWSSDK_PATH%\install\%ARCH%\%PLATFORM%\%build_type% -DANDROID_STL=%stl_type% ^
