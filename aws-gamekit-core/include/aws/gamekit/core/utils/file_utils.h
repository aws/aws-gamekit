...
namespace GameKit
{
    namespace Utils
    {
        ...
        private:
             ...
             * @return GAMEKIT_SUCCESS if the file was successfully opened, otherwise returns GAMEKIT_ERROR_FILE_OPEN_FAILED or GAMEKIT_ERROR_DIRECTORY_CREATE_FAILED.
             */
        ...
        public:
            ...
            * @return GAMEKIT_SUCCESS if the directory hash was successfully calculated and the return string written to, otherwise returns GAMEKIT_ERROR_DIRECTORY_NOT_FOUND.
            */
             ...
             * @return GAMEKIT_SUCCESS if the file was successfully read from and the string written to, otherwise returns GAMEKIT_ERROR_FILE_OPEN_FAILED or GAMEKIT_ERROR_FILE_READ_FAILED.
             */
             ...
             * @return GAMEKIT_SUCCESS if the file was successfully written to, otherwise returns GAMEKIT_ERROR_FILE_OPEN_FAILED, GAMEKIT_ERROR_FILE_WRITE_FAILED, or GAMEKIT_ERROR_DIRECTORY_CREATE_FAILED.
             */
             ...
             * @return GAMEKIT_SUCCESS if the file was successfully written to, otherwise returns GAMEKIT_ERROR_FILE_OPEN_FAILED, GAMEKIT_ERROR_FILE_WRITE_FAILED, or GAMEKIT_ERROR_DIRECTORY_CREATE_FAILED.
             */
            static unsigned int ReadFileContentsAsYAML(const std::string&, YAML::Node& returnedNode, FuncLogCallback logCallback = nullptr, const std::string& errorMessagePrefix = "");
            ...
            /**
             * @brief Converts platform-native path strings to UTF-8 for use with GameKit
             *
